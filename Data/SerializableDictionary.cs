...
namespace HyperModule
{
	...
	[Serializable]
	public class SerializableDictionary_StringString : SerializableDictionary<string, string> { }

	[Serializable]
	public class SerializableDictionary_StringBool : SerializableDictionary<string, bool> { }

	[Serializable]
	public class SerializableDictionary_StringInt : SerializableDictionary<string, int> { }

	[Serializable]
	public class SerializableDictionary_StringLong : SerializableDictionary<string, long> { }

	[Serializable]
	public class SerializableDictionary_StringFloat : SerializableDictionary<string, float> { }

	[Serializable]
	public class SerializableDictionary_StringDouble : SerializableDictionary<string, double> { }

	[Serializable]
	public class SerializableDictionary_StringVector2 : SerializableDictionary<string, Vector2> { }

	[Serializable]
	public class SerializableDictionary_StringVector3 : SerializableDictionary<string, Vector3> { }

	[Serializable]
	public class SerializableDictionary_StringColor : SerializableDictionary<string, Color> { }

	[Serializable]
	public class SerializableDictionary_StringAudioClip : SerializableDictionary<string, AudioClip> { }

	[Serializable]
	public class SerializableDictionary_StringMaterial : SerializableDictionary<string, Material> { }

	[Serializable]
	public class SerializableDictionary_StringTexture2D : SerializableDictionary<string, Texture2D> { }

	[Serializable]
	public class SerializableDictionary_StringTMP_FontAsset : SerializableDictionary<string, TMP_FontAsset> { }

	[Serializable]
	public class SerializableDictionary_StringScriptableObject : SerializableDictionary<string, ScriptableObject> { }

	[Serializable]
	public class SerializableDictionary_StringGameObject : SerializableDictionary<string, GameObject> { }

	[Serializable]
	public class SerializableDictionary_StringComponent : SerializableDictionary<string, Component> { }

	[Serializable]
	public class SerializableDictionary_StringTransform : SerializableDictionary<string, Transform> { }
